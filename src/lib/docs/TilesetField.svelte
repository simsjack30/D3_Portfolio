<script lang="ts">
	...
	export let doubleScale = false;

	// TODO: Access via context, or possibly global state
	const ACCESS_TOKEN =
		'pk.eyJ1Ijoic2ltc2phY2szMCIsImEiOiJjbHpoMzJwdzkwMGN2Mm9xMm94YzQza3RyIn0.EbQMwqwOVeDHjFRbO3Jiow';
	...
	let selected = 'mapbox v1:satelllite-v9';
